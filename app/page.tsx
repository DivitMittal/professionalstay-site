        ...
        <div className="container px-4 mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="bg-card hover:bg-accent transition-colors duration-300">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Comprehensive property management including tenant screening,
            ...
            <Card className="bg-card hover:bg-accent transition-colors duration-300">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Professional tenant communication and support for smooth
                  operations.
                </p>
              </CardContent>
            </Card>
            <Card className="bg-card hover:bg-accent transition-colors duration-300">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  24/7 maintenance support and regular property inspections.
                </p>
              </CardContent>
            </Card>
            <Card className="bg-card hover:bg-accent transition-colors duration-300">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Ensuring all properties meet legal requirements and
                  regulations.
                </p>
              </CardContent>
            </Card>
        ...
        <div className="container px-4 mx-auto">
          ...
          <div className="max-w-3xl mx-auto text-center">
            <p className="mb-6 text-lg text-foreground">
              ...
              is a leading property management company dedicated to maximizing
              the potential of your real estate investments. With years of
              experience and a commitment to excellence, we provide
              comprehensive solutions for property owners and tenants alike.
            </p>
            <p className="mb-6 text-lg text-foreground">
              Our team of{" "}
              <span className="text-secondary font-semibold">experts</span>{" "}
              handles every aspect of property management, from tenant screening
              and rent collection to maintenance and legal compliance. We
              understand that each property is unique, and we tailor our
              services to meet the specific needs of our clients.
            </p>
            <p className="text-lg text-foreground">
              ...
              with our clients based on trust, transparency, and results. Let us
              take the stress out of property management so you can enjoy the
        ...
        <div className="container px-4 mx-auto">
          <div className="max-w-2xl mx-auto text-center mb-12">
            ...
            <p className="text-muted-foreground mb-8">
              Let us help you manage your property portfolio with professional
              expertise.
            </p>
            <ContactForm />
          </div>
